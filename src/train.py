...
if __name__ == "__main__":
    ...
    parser.add_argument("--test_dir", help="path to folder with test problems with graph data", required=False)
    parser.add_argument("--val_dir", help="path to folder with val problems with graph data", required=False)
    ...
    parser.add_argument(
        "--model-settings",
        help="path to model settings json", required=True
    )
    ...
    train_and_save_model(
        models_dir, model_settings_path=model_settings, 
