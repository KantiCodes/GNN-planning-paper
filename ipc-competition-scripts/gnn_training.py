...
def run_step_gnn_learning(REPO_LEARNING, model_setting:"ModelSetting", problems_dir, output_dir, batch_size, time_limit=1200, memory_limit = 4*1024*1024):
    ...
    Call([sys.executable, f'{REPO_LEARNING}/src/train.py', train_dir, output_dir, "--model-settings", setting, "--num-epoch", num_epoch, "--batch-size", batch_size], "train-gnn", time_limit=time_limit, memory_limit=memory_limit).wait()
